package com.user4302.mika.data.handlers.anime
...
class QueryPagingAnimeSource<RowType : Any>(
    ...
    private var currentQuery: Query<RowType>? by
    ...
    override suspend fun load(params: LoadParams<Long>): LoadResult<Long, RowType> {
        try {
            ...
            val data = handler.awaitList { queryProvider(limit, offset).also { currentQuery = it } }
