package com.user4302.mika.domain.release.interactor
...
class GetApplicationRelease(
    ...
    private fun isNewVersion(
        ...
        return if (isPreview) {
            // Preview builds: based on releases in "user4302/mika-preview" repo
            // tagged as something like "r1234"
            newVersion.toInt() > commitCount
        } else {
            // Release builds: based on releases in "user4302/mika" repo
