...
package com.user4302.mika.presentation.core.components.material
...
fun Scaffold(
    ...
    // MiKa: Handle consumed window insets
...
private fun ScaffoldLayout(
    ...
    SubcomposeLayout { constraints ->
        ...
        /**
         * MiKa: Remove height constraint for expanded app bar
         */
        ...
        layout(layoutWidth, layoutHeight) {
            ...
            // MiKa: Add startBar slot for Navigation Rail
            ...
            // MiKa: layoutWidth after horizontal insets
            ...
            // MiKa: Calculate insets for snackbar placement offset
            ...
            val fabPlacement = if (fabPlaceables.isNotEmpty() && fabWidth != 0 && fabHeight != 0) {
                ...
                // MiKa: Calculate insets for fab placement offset
            ...
            val bodyContentPlaceables = subcompose(ScaffoldLayoutContent.MainContent) {
                ...
                val innerPadding = PaddingValues(
                    ...
                    // MiKa: Also take account of fab height when providing inner padding
