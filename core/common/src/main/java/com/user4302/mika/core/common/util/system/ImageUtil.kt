package com.user4302.mika.core.common.util.system
...
object ImageUtil {
    ...
    private fun getImageType(stream: InputStream): ImageType? {
        ...
        val mimeType = when {
            bytes.size >= 12 &&
                bytes.sliceArray(0..12).contentEquals(
                    byteArrayOf(
                        0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x18.toByte(),
                        0x66.toByte(), 0x74.toByte(), 0x79.toByte(), 0x70.toByte(),
                        0x61.toByte(), 0x76.toByte(), 0x69.toByte(), 0x66.toByte(),
                    ),
                ) -> "image/avif"
            bytes.size >= 4 &&
                bytes.sliceArray(
                    0..3,
                ).contentEquals(byteArrayOf(0x47.toByte(), 0x49.toByte(), 0x46.toByte(), 0x38.toByte())) -> "image/gif"
            bytes.size >= 12 &&
                bytes.sliceArray(0..12).contentEquals(
                    byteArrayOf(
            ...
            bytes.size >= 3 &&
                bytes.sliceArray(
                    0..2,
                ).contentEquals(byteArrayOf(0xFF.toByte(), 0xD8.toByte(), 0xFF.toByte())) -> "image/jpeg"
            bytes.size >= 12 &&
                bytes.sliceArray(0..12).contentEquals(
                    byteArrayOf(
                        0x00.toByte(), 0x00.toByte(), 0x00.toByte(), 0x0C.toByte(),
                        0x4A.toByte(), 0x58.toByte(), 0x4C.toByte(), 0x20.toByte(),
                        0x0D.toByte(), 0x0A.toByte(), 0x87.toByte(), 0x0A.toByte(),
                    ),
                ) -> "image/jxl"
            bytes.size >= 8 &&
    ...
    fun splitTallImage(tmpDir: UniFile, imageFile: UniFile, filenamePrefix: String): Boolean {
        ...
        if (bitmapRegionDecoder == null) {
            logcat(LogPriority.ERROR) { "Failed to create new instance of BitmapRegionDecoder" }
            return false
        }
