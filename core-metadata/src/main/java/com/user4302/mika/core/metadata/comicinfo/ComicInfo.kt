package com.user4302.mika.core.metadata.comicinfo
...
fun SManga.getComicInfo() = ComicInfo(
    ...
    publishingStatus = ComicInfo.PublishingStatusMika(
...
data class ComicInfo(
    ...
    val tags: Tags?,
    val web: Web?,
    val publishingStatus: PublishingStatusMika?,
    val categories: CategoriesMika?,
    val source: SourceMika?,
) {
    @XmlElement(false)
    ...
    @Serializable
    @XmlSerialName("PublishingStatusMika", "http://www.w3.org/2001/XMLSchema", "ty")
    data class PublishingStatusMika(@XmlValue(true) val value: String = "")

    @Serializable
    @XmlSerialName("Categories", "http://www.w3.org/2001/XMLSchema", "ty")
    data class CategoriesMika(@XmlValue(true) val value: String = "")

    @Serializable
    @XmlSerialName("SourceMika", "http://www.w3.org/2001/XMLSchema", "ay")
    data class SourceMika(@XmlValue(true) val value: String = "")
}
