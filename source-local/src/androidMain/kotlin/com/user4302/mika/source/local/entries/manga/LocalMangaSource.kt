package com.user4302.mika.source.local.entries.manga
...
import com.user4302.mika.core.metadata.comicinfo.COMIC_INFO_FILE
import com.user4302.mika.core.metadata.comicinfo.ComicInfo
import com.user4302.mika.core.metadata.comicinfo.copyFromComicInfo
import com.user4302.mika.core.metadata.comicinfo.getComicInfo
import com.user4302.mika.core.metadata.mika.ChapterDetails
import com.user4302.mika.core.metadata.mika.MangaDetails
import com.user4302.mika.domain.entries.manga.model.Manga
import com.user4302.mika.domain.items.chapter.service.ChapterRecognition
...
import com.user4302.mika.source.UnmeteredSource
import com.user4302.mika.source.local.filter.manga.MangaOrderBy
import com.user4302.mika.source.local.image.manga.LocalMangaCoverManager
import com.user4302.mika.source.local.io.ArchiveManga
import com.user4302.mika.source.local.io.Format
import com.user4302.mika.source.local.io.manga.LocalMangaSourceFileSystem
import com.user4302.mika.source.local.metadata.fillMetadata
...
actual class LocalMangaSource(
    ...
    fun getFormat(chapter: SChapter): Format {
        try {
            ...
            return fileSystem.getBaseDirectory()
                ...
                ?: throw Exception(context.stringResource(AYMR.strings.chapter_not_found))
        } catch (e: Format.UnknownFormatException) {
            throw Exception(context.stringResource(AYMR.strings.local_invalid_format))
        } catch (e: Exception) {
            throw e
        }
    }
    ...
    companion object {
        const val ID = 0L
        const val HELP_URL = "https://mika.org/help/guides/local-manga/"
