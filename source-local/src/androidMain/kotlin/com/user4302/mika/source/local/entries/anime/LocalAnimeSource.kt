...
import com.user4302.mika.core.metadata.mika.AnimeDetails
import com.user4302.mika.core.metadata.mika.EpisodeDetails
import com.user4302.mika.domain.entries.anime.model.Anime
import com.user4302.mika.domain.items.episode.service.EpisodeRecognition
import com.user4302.mika.source.local.filter.anime.AnimeOrderBy
...
actual class LocalAnimeSource(
    ...
    companion object {
        const val ID = 0L
        const val HELP_URL = "https://mika.org/help/guides/local-anime/"
