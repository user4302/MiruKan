package com.user4302.mika.util.lang

import android.content.Context
import com.user4302.mika.core.common.i18n.pluralStringResource
...
fun LocalDate.toRelativeString(
    ...
    return when {
        ...
        difference < 0 -> context.pluralStringResource(
            AYMR.plurals.upcoming_relative_time,
            difference.toInt().absoluteValue,
            difference.toInt().absoluteValue,
        )
        difference < 1 -> context.stringResource(AYMR.strings.relative_time_today)
        difference < 7 -> context.pluralStringResource(
            AYMR.plurals.relative_time,
            difference.toInt(),
            difference.toInt(),
        )
