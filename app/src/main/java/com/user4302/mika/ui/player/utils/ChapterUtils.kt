package com.user4302.mika.ui.player.utils
...
class ChapterUtils {
    companion object {
        fun ChapterType.getStringRes(): StringResource? = when (this) {
            ChapterType.Opening -> MR.strings.label_auto
            ChapterType.Ending -> MR.strings.label_auto
            ChapterType.Recap -> MR.strings.label_auto
            ChapterType.MixedOp -> MR.strings.label_auto
