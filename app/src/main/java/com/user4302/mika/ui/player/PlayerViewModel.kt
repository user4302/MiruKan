 ...
 * PlayerViewModel from MiKa.
 */

package com.user4302.mika.ui.player
...
import com.user4302.domain.items.episode.model.toDbEpisode
...
import com.user4302.mika.animesource.model.ChapterType
import com.user4302.mika.animesource.model.Hoster
import com.user4302.mika.animesource.model.SerializableHoster.Companion.toHosterList
import com.user4302.mika.animesource.model.TimeStamp
...
import com.user4302.mika.data.database.models.anime.isRecognizedNumber
import com.user4302.mika.data.database.models.anime.toDomainEpisode
import com.user4302.mika.data.database.models.manga.isRecognizedNumber
...
import com.user4302.mika.data.saver.Image
import com.user4302.mika.data.saver.ImageSaver
import com.user4302.mika.data.saver.Location
...
import com.user4302.mika.ui.player.controls.components.IndexedSegment
import com.user4302.mika.ui.player.controls.components.sheets.HosterState
import com.user4302.mika.ui.player.controls.components.sheets.getChangedAt
import com.user4302.mika.ui.player.loader.EpisodeLoader
import com.user4302.mika.ui.player.loader.HosterLoader
...
import com.user4302.mika.ui.player.utils.AniSkipApi
import com.user4302.mika.ui.player.utils.ChapterUtils.Companion.getStringRes
import com.user4302.mika.ui.player.utils.TrackSelect
import com.user4302.mika.ui.reader.SaveImageNotifier
import com.user4302.mika.util.editBackground
import com.user4302.mika.util.editCover
import com.user4302.mika.util.editThumbnail
import com.user4302.mika.util.episode.filterDownloadedEpisodes
import com.user4302.mika.util.lang.byteSize
import com.user4302.mika.util.lang.takeBytes
import com.user4302.mika.util.storage.DiskUtil
import com.user4302.mika.util.storage.cacheImageDir
import com.user4302.mika.util.system.toast
import com.user4302.presentation.more.settings.screen.player.custombutton.CustomButtonFetchState
import com.user4302.presentation.more.settings.screen.player.custombutton.getButtons
