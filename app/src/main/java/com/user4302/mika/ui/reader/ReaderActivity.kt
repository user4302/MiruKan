package com.user4302.mika.ui.reader
...
import com.user4302.mika.data.notification.NotificationReceiver
import com.user4302.mika.data.notification.Notifications
import com.user4302.mika.databinding.ReaderActivityBinding
...
import com.user4302.mika.ui.reader.ReaderViewModel.SetAsCoverResult.AddToLibraryFirst
import com.user4302.mika.ui.reader.ReaderViewModel.SetAsCoverResult.Error
import com.user4302.mika.ui.reader.ReaderViewModel.SetAsCoverResult.Success
import com.user4302.mika.ui.reader.model.ReaderChapter
import com.user4302.mika.ui.reader.model.ReaderPage
import com.user4302.mika.ui.reader.model.ViewerChapters
...
import com.user4302.mika.ui.reader.viewer.ReaderProgressIndicator
import com.user4302.mika.ui.webview.WebViewActivity
import com.user4302.mika.util.system.hasDisplayCutout
import com.user4302.mika.util.system.isNightMode
...
import com.user4302.presentation.reader.DisplayRefreshHost
import com.user4302.presentation.reader.OrientationSelectDialog
import com.user4302.presentation.reader.PageIndicatorText
import com.user4302.presentation.reader.ReaderContentOverlay
import com.user4302.presentation.reader.ReaderPageActionsDialog
import com.user4302.presentation.reader.ReadingModeSelectDialog
import com.user4302.presentation.reader.appbars.ReaderAppBars
import com.user4302.presentation.reader.settings.ReaderSettingsDialog
    ...
    private inner class ReaderConfig {
        ...
        private fun setDisplayProfile(path: String) {
            ...
            if (file != null && file.exists()) {
                ...
                MikaImageDecoder.displayProfile = data
            }
        }
