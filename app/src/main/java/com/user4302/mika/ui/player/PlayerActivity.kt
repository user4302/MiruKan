...
import com.user4302.mika.animesource.model.SerializableHoster.Companion.serialize
...
import com.user4302.mika.databinding.PlayerLayoutBinding
...
import com.user4302.mika.ui.player.controls.PlayerControls
...
import com.user4302.mika.ui.player.utils.ChapterUtils
...
class PlayerActivity : BaseActivity() {
    ...
    private fun copyUserFiles(mpvDir: UniFile) {
        ...
        // Then, copy the user files from the MiKa directory
        ...
        val luaFile = scriptsDir()?.createFile("mika.lua")
        val luaBridge = assets.open("mika.lua")
    ...
    internal fun onObserverEvent(property: String, value: String) {
        ...
        when (property.substringBeforeLast("/")) {
            ...
            "user-data/mika" -> viewModel.handleLuaInvocation(property, value)
        }
    }
    ...
    // at void com.user4302.mika.ui.player.PlayerActivity.fileLoaded() (PlayerActivity.kt:1874)
    // at void com.user4302.mika.ui.player.PlayerActivity.event(int) (PlayerActivity.kt:1566)
