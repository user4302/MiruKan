...
import com.user4302.mika.ui.player.controls.components.panels.toColorHexString
...
class MikaMPVView(context: Context, attributes: AttributeSet) : BaseMPVView(context, attributes) {
    ...
    private val observedProps = mapOf(
        ...
        "user-data/mika/show_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/toggle_ui" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/show_panel" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/software_keyboard" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/set_button_title" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/reset_button_title" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/toggle_button" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/switch_episode" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/pause" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/seek_by" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/seek_to" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/seek_by_with_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/seek_to_with_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/mika/launch_int_picker" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
