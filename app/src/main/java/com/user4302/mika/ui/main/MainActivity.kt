package com.user4302.mika.ui.main
...
import com.user4302.mika.extension.anime.api.AnimeExtensionApi
import com.user4302.mika.extension.manga.api.MangaExtensionApi
...
import com.user4302.mika.ui.deeplink.anime.DeepLinkAnimeScreen
import com.user4302.mika.ui.deeplink.manga.DeepLinkMangaScreen
...
import com.user4302.mika.util.system.dpToPx
import com.user4302.mika.util.system.isNavigationBarNeedsScrim
...
import com.user4302.presentation.components.AppStateBanners
import com.user4302.presentation.components.DownloadedOnlyBannerBackgroundColor
import com.user4302.presentation.components.IncognitoModeBannerBackgroundColor
import com.user4302.presentation.components.IndexingBannerBackgroundColor
...
class MainActivity : BaseActivity() {
    ...
    private fun handleIntentAction(intent: Intent, navigator: Navigator): Boolean {
        ...
        val tabToOpen = when (intent.action) {
            ...
            Intent.ACTION_SEARCH, Intent.ACTION_SEND, "com.google.android.gms.actions.SEARCH_ACTION" -> {
                ...
                // or the Google-specific search intent (triggered by saying or typing "search *query* on *MiKa*" in Google Search/Google Assistant)
            ...
            Intent.ACTION_VIEW -> {
                ...
                else if (intent.scheme == "mika" && intent.data?.host == "add-repo") {
    ...
    companion object {
        const val INTENT_SEARCH = "com.user4302.mika.SEARCH"
        const val INTENT_ANIMESEARCH = "com.user4302.mika.ANIMESEARCH"
