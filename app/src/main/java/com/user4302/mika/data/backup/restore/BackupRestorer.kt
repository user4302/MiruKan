package com.user4302.mika.data.backup.restore

import android.content.Context
import android.net.Uri
import com.user4302.mika.core.common.i18n.stringResource
import com.user4302.mika.data.backup.BackupDecoder
import com.user4302.mika.data.backup.BackupNotifier
...
import com.user4302.mika.data.backup.restore.restorers.AnimeCategoriesRestorer
import com.user4302.mika.data.backup.restore.restorers.AnimeExtensionRepoRestorer
import com.user4302.mika.data.backup.restore.restorers.AnimeRestorer
import com.user4302.mika.data.backup.restore.restorers.CustomButtonRestorer
import com.user4302.mika.data.backup.restore.restorers.ExtensionsRestorer
import com.user4302.mika.data.backup.restore.restorers.MangaCategoriesRestorer
import com.user4302.mika.data.backup.restore.restorers.MangaExtensionRepoRestorer
import com.user4302.mika.data.backup.restore.restorers.MangaRestorer
import com.user4302.mika.data.backup.restore.restorers.PreferenceRestorer
    ...
    private fun writeErrorLog(): File {
        try {
            if (errors.isNotEmpty()) {
                val file = context.createFileInCacheDir("mika_restore_error.txt")
