package com.user4302.mika.data.track.jellyfin
...
import okhttp3.Dns
import com.user4302.mika.domain.track.anime.model.AnimeTrack as DomainTrack
...
class Jellyfin(id: Long) : BaseTracker(id, "Jellyfin"), EnhancedAnimeTracker, AnimeTracker {
    ...
    override fun getAcceptedSources() = listOf("com.user4302.mika.animeextension.all.jellyfin.Jellyfin")
