...
import com.user4302.mika.animesource.AnimeSourceFactory
import com.user4302.mika.core.common.util.system.logcat
import com.user4302.mika.extension.anime.model.AnimeExtension
import com.user4302.mika.extension.anime.model.AnimeLoadResult
import com.user4302.mika.util.lang.Hash
import com.user4302.mika.util.storage.copyAndSetReadOnlyTo
import com.user4302.mika.util.system.ChildFirstPathClassLoader
...
internal object AnimeExtensionLoader {
    ...
    private const val EXTENSION_FEATURE = "mika.animeextension"
    private const val METADATA_SOURCE_CLASS = "mika.animeextension.class"
    private const val METADATA_SOURCE_FACTORY = "mika.animeextension.factory"
    private const val METADATA_NSFW = "mika.animeextension.nsfw"
    private const val METADATA_HAS_README = "mika.animeextension.hasReadme"
    private const val METADATA_HAS_CHANGELOG = "mika.animeextension.hasChangelog"
    ...
    private suspend fun loadExtension(context: Context, extensionInfo: AnimeExtensionInfo): AnimeLoadResult {
        ...
        val extName = pkgManager.getApplicationLabel(appInfo).toString().substringAfter("MiKa: ")
