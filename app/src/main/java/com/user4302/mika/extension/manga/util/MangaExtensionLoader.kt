...
import com.user4302.mika.extension.manga.model.MangaLoadResult
import com.user4302.mika.source.CatalogueSource
import com.user4302.mika.source.MangaSource
import com.user4302.mika.source.SourceFactory
 ...
 * installer, so other variants of MiKa/MiKa and its forks can also use this extension.
 *
...
internal object MangaExtensionLoader {
    ...
    private const val EXTENSION_FEATURE = "mika.extension"
    private const val METADATA_SOURCE_CLASS = "mika.extension.class"
    private const val METADATA_SOURCE_FACTORY = "mika.extension.factory"
    private const val METADATA_NSFW = "mika.extension.nsfw"
