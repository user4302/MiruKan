...
private fun DownloadedOnlyModeBanner(modifier: Modifier = Modifier) {
    Text(
        text = stringResource(AYMR.strings.label_downloaded_only),
        modifier = Modifier
...
private fun IncognitoModeBanner(modifier: Modifier = Modifier) {
    Text(
        text = stringResource(AYMR.strings.pref_incognito_mode),
        modifier = Modifier
...
private fun IndexingDownloadBanner(modifier: Modifier = Modifier) {
    ...
    Row(
        ...
        Text(
            text = stringResource(AYMR.strings.download_notifier_cache_renewal),
            color = MaterialTheme.colorScheme.onSecondary,
            textAlign = TextAlign.Center,
            style = MaterialTheme.typography.labelMedium,
            onTextLayout = {
