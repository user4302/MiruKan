...
import com.user4302.presentation.more.settings.screen.player.custombutton.CustomButtonScreenState
...
fun CustomButtonScreen(
    ...
    Scaffold(
        topBar = { scrollBehavior ->
            AppBar(
                title = stringResource(AYAYMR.strings.pref_player_custom_button_header),
                navigateUp = navigateUp,
                actions = {
                    IconButton(onClick = onClickFAQ) {
                        Icon(
                            imageVector = Icons.AutoMirrored.Outlined.HelpOutline,
                            contentDescription = stringResource(AYAYMR.strings.pref_player_custom_button_guide),
                        )
                    }
                },
        ...
        if (state.isEmpty) {
            EmptyScreen(
                stringRes = AYAYMR.strings.pref_player_custom_button_empty,
