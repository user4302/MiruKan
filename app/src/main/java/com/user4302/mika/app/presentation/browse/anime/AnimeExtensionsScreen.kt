...
import com.user4302.mika.ui.browse.anime.extension.AnimeExtensionUiModel
...
import com.user4302.presentation.browse.manga.ExtensionHeader
import com.user4302.presentation.browse.manga.ExtensionTrustDialog
    ...
    Column(
        ...
        FlowRow(
            ...
            ProvideTextStyle(value = MaterialTheme.typography.bodySmall) {
                ...
                val warning = when {
                    extension is AnimeExtension.Untrusted -> AYMR.strings.ext_untrusted
                    extension is AnimeExtension.Installed && extension.isObsolete -> AYMR.strings.ext_obsolete
