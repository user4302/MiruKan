...
import com.user4302.mika.ui.player.controls.components.sheets.QualitySheetHosterContent
import com.user4302.mika.ui.player.controls.components.sheets.QualitySheetVideoContent
...
fun EpisodeOptionsDialog(
    ...
    Column(
        ...
        Text(
            text = stringResource(AYAYMR.strings.choose_video_quality),
            modifier = Modifier.padding(horizontal = TabbedDialogPaddings.Horizontal),
...
private fun VideoList(
    ...
    val context = LocalContext.current
    val scope = rememberCoroutineScope()
    val copiedString = stringResource(AYAYMR.strings.copied_video_link_to_clipboard)
...
private fun QualityOptions(
    ...
    Column {
        ClickableRow(
            text = stringResource(AYMR.strings.copy),
            icon = Icons.Outlined.ContentCopy,
            onClick = { onCopyClicked() },
        )

        ClickableRow(
            text = stringResource(AYAYMR.strings.action_start_download_internally),
        ...
        ClickableRow(
            text = stringResource(AYAYMR.strings.action_start_download_externally),
        ...
        ClickableRow(
            text = stringResource(AYAYMR.strings.action_play_externally),
        ...
        ClickableRow(
            text = stringResource(AYAYMR.strings.action_play_internally),
