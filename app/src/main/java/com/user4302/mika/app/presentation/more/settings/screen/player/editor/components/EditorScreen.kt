...
import com.user4302.presentation.components.FloatingActionAddButton
import com.user4302.presentation.more.settings.screen.player.editor.EditorListItem
import com.user4302.presentation.more.settings.screen.player.editor.EditorListType
import com.user4302.presentation.more.settings.screen.player.editor.EditorScreenState
    ...
    Scaffold(
        ...
        when (state) {
            ...
            is EditorScreenState.Success -> {
                if (state.isEmpty) {
                    EmptyScreen(
                        stringRes = AYAYMR.strings.pref_player_no_items,
    ...
    ListItem(
        ...
        trailingContent = {
            DropdownMenu(
                ...
                DropdownMenuItem(
                    text = { Text(text = stringResource(AYAYMR.strings.editor_action_rename)) },
                    onClick = {
                        onRename()
                        onExpand(false)
                    },
                ...
                DropdownMenuItem(
                    text = { Text(text = stringResource(AYAYMR.strings.editor_action_delete)) },
                    onClick = {
                        onDelete()
                        onExpand(false)
                    },
