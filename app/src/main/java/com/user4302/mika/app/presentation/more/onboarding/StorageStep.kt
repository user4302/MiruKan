...
import com.user4302.mika.presentation.core.components.material.Button
import com.user4302.mika.presentation.core.components.material.padding
import com.user4302.mika.presentation.core.i18n.stringResource
import com.user4302.mika.util.system.isTvBox
...
internal class StorageStep : OnboardingStep {
    ...
    override fun Content() {
        ...
        Column(
            ...
            Text(
                stringResource(
                    AYMR.strings.onboarding_storage_info,
            ...
            if (isTvBox) {
                if (!storagePref.isSet()) {
                    Button(
                        ...
                        Text(stringResource(AYAYMR.strings.onboarding_storage_action_create_folder))
                    }
                }
            } else {
                Button(
                    ...
                    Text(stringResource(AYMR.strings.onboarding_storage_action_select))
                }
            }
            ...
            Text(stringResource(AYMR.strings.onboarding_storage_help_info, stringResource(AYMR.strings.app_name)))
            Button(
                modifier = Modifier.fillMaxWidth(),
                onClick = { handler.openUri(SettingsDataScreen.HELP_URL) },
            ) {
                Text(stringResource(AYMR.strings.onboarding_storage_help_action))
            }
        }
