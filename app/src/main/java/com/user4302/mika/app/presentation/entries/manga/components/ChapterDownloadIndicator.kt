...
import com.user4302.mika.presentation.core.components.material.IconButtonTokens
import com.user4302.mika.presentation.core.i18n.stringResource
import com.user4302.mika.presentation.core.util.secondaryItemAlpha
import com.user4302.presentation.components.ArrowModifier
import com.user4302.presentation.components.DropdownMenu
import com.user4302.presentation.components.IndicatorModifier
import com.user4302.presentation.components.IndicatorSize
import com.user4302.presentation.components.IndicatorStrokeWidth
import com.user4302.presentation.components.commonClickable
...
private fun NotDownloadedIndicator(
    ...
    Box(
        ...
        Icon(
            ...
            contentDescription = stringResource(AYMR.strings.manga_download),
...
private fun DownloadingIndicator(
    ...
    Box(
        ...
        DropdownMenu(expanded = isMenuExpanded, onDismissRequest = { isMenuExpanded = false }) {
            DropdownMenuItem(
                text = { Text(text = stringResource(AYMR.strings.action_start_downloading_now)) },
                onClick = {
            ...
            DropdownMenuItem(
                text = { Text(text = stringResource(AYMR.strings.action_cancel)) },
                onClick = {
...
private fun ErrorIndicator(
    ...
    Box(
        ...
        Icon(
            ...
            contentDescription = stringResource(AYAYMR.strings.download_error),
            modifier = Modifier.size(IndicatorSize),
