package com.user4302.presentation.more.settings.screen.player.custombutton
...
import com.user4302.presentation.more.settings.screen.player.custombutton.components.CustomButtonCreateDialog
import com.user4302.presentation.more.settings.screen.player.custombutton.components.CustomButtonDeleteDialog
import com.user4302.presentation.more.settings.screen.player.custombutton.components.CustomButtonEditDialog
import com.user4302.presentation.more.settings.screen.player.custombutton.components.CustomButtonScreen
...
object PlayerSettingsCustomButtonScreen : Screen() {
    ...
    override fun Content() {
        ...
        CustomButtonScreen(
            state = successState,
            onClickFAQ = { uriHandler.openUri("https://mika.org/docs/guides/player-settings/custom-buttons") },
