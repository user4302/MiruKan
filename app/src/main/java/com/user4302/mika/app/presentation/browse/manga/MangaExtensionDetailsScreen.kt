...
import com.user4302.domain.extension.manga.interactor.MangaExtensionSourceItem
...
import com.user4302.mika.ui.browse.manga.extension.details.MangaExtensionDetailsScreenModel
...
private fun DetailsHeader(
    ...
    Column {
        Column(
            ...
            val strippedPkgName = extension.pkgName.substringAfter("com.user4302.mika.extension.")
...
fun NsfwWarningDialog(
    ...
    AlertDialog(
        text = {
            Text(text = stringResource(AYMR.strings.ext_nsfw_warning))
        },
        confirmButton = {
