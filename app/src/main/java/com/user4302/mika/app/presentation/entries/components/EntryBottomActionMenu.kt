        ...
        Surface(
            ...
            Row(
                ...
                if (onBookmarkClicked != null) {
                    val bookmark = if (isManga) AYMR.strings.action_bookmark else AYAYMR.strings.action_bookmark_episode
                    Button(
                ...
                if (onRemoveBookmarkClicked != null) {
                    val removeBookmark = if (isManga) {
                        AYMR.strings.action_remove_bookmark
                    } else {
                        AYAYMR.strings.action_remove_bookmark_episode
                    }
                    Button(
                ...
                if (onFillermarkClicked != null) {
                    Button(
                        title = stringResource(AYAYMR.strings.action_fillermark_episode),
                ...
                if (onRemoveFillermarkClicked != null) {
                    Button(
                        title = stringResource(AYAYMR.strings.action_remove_fillermark_episode),
                ...
                if (onMarkAsViewedClicked != null) {
                    val viewed = if (isManga) AYMR.strings.action_mark_as_read else AYAYMR.strings.action_mark_as_seen
                    Button(
                ...
                if (onMarkAsUnviewedClicked != null) {
                    val unviewed = if (isManga) {
                        AYMR.strings.action_mark_as_unread
                    } else {
                        AYAYMR.strings.action_mark_as_unseen
                    }
                    Button(
                ...
                if (onMarkPreviousAsViewedClicked != null) {
                    val previousUnviewed = if (isManga) {
                        AYMR.strings.action_mark_previous_as_read
                    } else {
                        AYAYMR.strings.action_mark_previous_as_seen
                    }
                    Button(
                ...
                if (onDownloadClicked != null) {
                    Button(
                        title = stringResource(AYMR.strings.action_download),
                ...
                if (onDeleteClicked != null) {
                    Button(
                        title = stringResource(AYMR.strings.action_delete),
                ...
                if (!isManga && onExternalClicked != null && !playerPreferences.alwaysUseExternalPlayer().get()) {
                    Button(
                        title = stringResource(AYAYMR.strings.action_play_externally),
                ...
                if (!isManga && onInternalClicked != null && playerPreferences.alwaysUseExternalPlayer().get()) {
                    Button(
                        title = stringResource(AYAYMR.strings.action_play_internally),
    ...
    AnimatedVisibility(
        ...
        Surface(
            ...
            Row(
                ...
                Button(
                    title = stringResource(AYMR.strings.action_move_category),
                ...
                val unviewed = if (isManga) AYMR.strings.action_mark_as_unread else AYAYMR.strings.action_mark_as_unseen
                Button(
                    title = stringResource(unviewed),
                    icon = Icons.Outlined.RemoveDone,
                    toConfirm = confirm[2],
