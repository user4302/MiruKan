...
import com.user4302.presentation.browse.manga.components.MangaSourceIcon
            ...
            is ClearDatabaseScreenModel.State.Ready -> {
                if (s.showConfirmation) {
                    AlertDialog(
                        ...
                        text = {
                            Text(text = stringResource(AYAYMR.strings.clear_database_confirmation))
                        },
                    )
                }
                ...
                Scaffold(
                    ...
                    if (s.items.isEmpty()) {
                        ...
                        LazyColumnWithAction(
                            ...
                            actionLabel = stringResource(AYMR.strings.action_delete),
