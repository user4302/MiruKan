...
fun StorageItem(
    ...
    val pluralCount = if (isManga) AYMR.plurals.manga_num_chapters else AYAYMR.plurals.anime_num_episodes
...
private fun ItemDeleteDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(
                    if (isManga) AYMR.strings.delete_downloads_for_manga else AYAYMR.strings.delete_downloads_for_anime,
                ),
            )
        },
        text = {
            Text(
                text = stringResource(AYAYMR.strings.delete_confirmation, title),
            )
        },
    )
}
