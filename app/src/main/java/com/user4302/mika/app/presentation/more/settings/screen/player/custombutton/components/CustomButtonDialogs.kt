package com.user4302.presentation.more.settings.screen.player.custombutton.components
...
import com.user4302.presentation.more.settings.screen.player.editor.codeeditor.githubTheme
import com.user4302.presentation.more.settings.screen.player.editor.codeeditor.luaHighlight
import com.user4302.presentation.more.settings.screen.player.editor.codeeditor.toAnnotatedString
        ...
        title = {
            Row {
                ...
                initialState?.id?.let { buttonId ->
                    ...
                    Text(
                        text = stringResource(AYAYMR.strings.pref_player_custom_button_id, buttonId),
        ...
        text = {
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_title))
                    },
                    supportingText = {
                        val msgRes = if (title.isNotEmpty() && titleAlreadyExists) {
                            AYAYMR.strings.pref_player_custom_button_error_exists
                        } else {
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_content))
                    },
                    supportingText = {
                        Text(text = stringResource(AYMR.strings.information_required_plain))
                    },
                    minLines = 3,
                    maxLines = 5,
                )
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_content_long))
                    },
                    supportingText = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_optional))
                    },
                    minLines = 3,
                    maxLines = 5,
                )
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_startup))
                    },
                    supportingText = {
                        Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_optional))
                    },
...
fun CustomButtonCreateDialog(
    ...
    CustomButtonButtonDialog(
        onDismissRequest = onDismissRequest,
        onAction = onCreate,
        titleRes = AYAYMR.strings.pref_player_custom_button_add,
        actionRes = AYMR.strings.action_add,
...
fun CustomButtonEditDialog(
    ...
    CustomButtonButtonDialog(
        onDismissRequest = onDismissRequest,
        onAction = onEdit,
        titleRes = AYAYMR.strings.pref_player_custom_button_edit,
        actionRes = AYMR.strings.action_edit,
        buttonNames = buttonNames,
...
fun CustomButtonDeleteDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_delete))
        },
        text = {
            Text(text = stringResource(AYAYMR.strings.pref_player_custom_button_delete_confirm, buttonTitle))
        },
    )
}
