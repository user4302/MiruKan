...
fun NewUpdateScreen(
    ...
    InfoScreen(
        ...
        headingText = stringResource(AYMR.strings.update_check_notification_update_available),
        subtitleText = versionName,
        acceptText = stringResource(AYMR.strings.update_check_confirm),
        onAcceptClick = onAcceptUpdate,
        rejectText = stringResource(AYMR.strings.action_not_now),
        ...
        RichText(
            ...
            TextButton(
                ...
                Text(text = stringResource(AYMR.strings.update_check_open))
