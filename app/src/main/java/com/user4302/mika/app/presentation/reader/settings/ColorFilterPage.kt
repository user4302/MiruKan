...
import com.user4302.mika.ui.reader.setting.ReaderPreferences.Companion.ColorFilterMode
...
internal fun ColumnScope.ColorFilterPage(screenModel: ReaderSettingsScreenModel) {
    ...
    CheckboxItem(
        label = stringResource(AYMR.strings.pref_custom_brightness),
    ...
    CheckboxItem(
        label = stringResource(AYMR.strings.pref_custom_color_filter),
    ...
    if (colorFilter) {
        ...
        SliderItem(
            ...
            valueRange = 0..255,
            steps = 0,
            label = stringResource(AYMR.strings.color_filter_r_value),
            onChange = { newRValue ->
        ...
        SliderItem(
            ...
            valueRange = 0..255,
            steps = 0,
            label = stringResource(AYMR.strings.color_filter_g_value),
            onChange = { newGValue ->
                screenModel.preferences.colorFilterValue().getAndSet {
        ...
        SliderItem(
            ...
            valueRange = 0..255,
            steps = 0,
            label = stringResource(AYMR.strings.color_filter_b_value),
            onChange = { newBValue ->
                screenModel.preferences.colorFilterValue().getAndSet {
        ...
        SliderItem(
            ...
            valueRange = 0..255,
            steps = 0,
            label = stringResource(AYMR.strings.color_filter_a_value),
            onChange = { newAValue ->
                screenModel.preferences.colorFilterValue().getAndSet {
        ...
        SettingsChipRow(AYMR.strings.pref_color_filter_mode) {
    ...
    CheckboxItem(
        label = stringResource(AYMR.strings.pref_grayscale),
        pref = screenModel.preferences.grayscale(),
    )
    CheckboxItem(
        label = stringResource(AYMR.strings.pref_inverted_colors),
