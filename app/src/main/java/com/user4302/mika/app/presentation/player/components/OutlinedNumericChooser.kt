...
package com.user4302.presentation.player.components
...
fun OutlinedNumericChooser(
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            supportingText = {
                if (value > max) Text(stringResource(AYAYMR.strings.numeric_chooser_value_too_big))
                if (value < min) Text(stringResource(AYAYMR.strings.numeric_chooser_value_too_small))
            },
            suffix = suffix,
