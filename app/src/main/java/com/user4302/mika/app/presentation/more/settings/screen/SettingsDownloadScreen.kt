...
import com.user4302.mika.presentation.core.components.OutlinedNumericChooser
...
object SettingsDownloadScreen : SearchableSettings {
    ...
    @ReadOnlyComposable
    @Composable
    override fun getTitleRes() = AYMR.strings.pref_category_downloads
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            Preference.PreferenceItem.SwitchPreference(
                ...
                title = stringResource(AYMR.strings.connected_to_wifi),
            ),
            Preference.PreferenceItem.TextPreference(
                title = stringResource(AYAYMR.strings.download_speed_limit),
                subtitle = if (speedLimit == 0) {
                    stringResource(AYMR.strings.off)
                } else {
                    "$speedLimit KiB/s"
                },
            ...
            Preference.PreferenceItem.SwitchPreference(
                ...
                title = stringResource(AYMR.strings.save_chapter_as_cbz),
            ),
            Preference.PreferenceItem.SwitchPreference(
                preference = downloadPreferences.splitTallImages(),
                title = stringResource(AYMR.strings.split_tall_images),
                subtitle = stringResource(AYMR.strings.split_tall_images_summary),
            ),
            Preference.PreferenceItem.ListPreference(
                preference = downloadPreferences.numberOfDownloads(),
                entries = (1..5).associateWith { it.toString() }.toImmutableMap(),
                title = stringResource(AYAYMR.strings.pref_download_slots),
            ),
            Preference.PreferenceItem.InfoPreference(stringResource(AYAYMR.strings.download_slots_info)),
    ...
    private fun getDeleteChaptersGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_delete_chapters),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadPreferences.removeAfterMarkedAsRead(),
                    title = stringResource(AYAYMR.strings.pref_remove_after_marked_as_read),
                ),
                Preference.PreferenceItem.ListPreference(
                    preference = downloadPreferences.removeAfterReadSlots(),
                    entries = persistentMapOf(
                        -1 to stringResource(AYMR.strings.disabled),
                        0 to stringResource(AYMR.strings.last_read_chapter),
                        1 to stringResource(AYMR.strings.second_to_last),
                        2 to stringResource(AYMR.strings.third_to_last),
                        3 to stringResource(AYMR.strings.fourth_to_last),
                        4 to stringResource(AYMR.strings.fifth_to_last),
                    ),
                    title = stringResource(AYAYMR.strings.pref_remove_after_read),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadPreferences.removeBookmarkedChapters(),
                    title = stringResource(AYAYMR.strings.pref_remove_bookmarked_chapters),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadPreferences.downloadFillermarkedItems(),
                    title = stringResource(AYAYMR.strings.pref_download_fillermarked_items),
                ),
    ...
    private fun getExcludedCategoriesPreference(
        ...
        return Preference.PreferenceItem.MultiSelectListPreference(
            ...
            entries = categories()
                ...
                .toImmutableMap(),
            title = stringResource(AYAYMR.strings.pref_remove_exclude_categories_manga),
        )
    }
    ...
    private fun getExcludedAnimeCategoriesPreference(
        ...
        return Preference.PreferenceItem.MultiSelectListPreference(
            ...
            entries = categories()
                .associate { it.id.toString() to it.visualName }
                .toImmutableMap(),
            title = stringResource(AYAYMR.strings.pref_remove_exclude_categories_anime),
        )
    }
    ...
    private fun getAutoDownloadGroup(
        ...
        if (showAnimeDialog) {
            TriStateListDialog(
                ...
                message = stringResource(AYMR.strings.pref_download_new_categories_details),
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYMR.strings.pref_category_auto_download),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadNewEpisodesPref,
                    title = stringResource(AYAYMR.strings.pref_download_new_episodes),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadNewUnseenEpisodesOnlyPref,
                    title = stringResource(AYAYMR.strings.pref_download_new_unseen_episodes_only),
                ...
                Preference.PreferenceItem.SwitchPreference(
                    ...
                    title = stringResource(AYMR.strings.pref_download_new),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = downloadNewUnreadChaptersOnlyPref,
                    title = stringResource(AYMR.strings.pref_download_new_unread_chapters_only),
    ...
    private fun getDownloadAheadGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYMR.strings.download_ahead),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = listOf(0, 2, 3, 5, 10)
                        .associateWith {
                            if (it == 0) {
                                ...
                                pluralStringResource(AYAYMR.plurals.next_unseen_episodes, count = it, it)
                            }
                        }
                        .toImmutableMap(),
                    title = stringResource(AYAYMR.strings.auto_download_while_watching),
                ),
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = listOf(0, 2, 3, 5, 10)
                        .associateWith {
                            if (it == 0) {
                                ...
                                pluralStringResource(AYMR.plurals.next_unread_chapters, count = it, it)
                            }
                        }
                        .toImmutableMap(),
                    title = stringResource(AYMR.strings.auto_download_while_reading),
                ),
                Preference.PreferenceItem.InfoPreference(
                    stringResource(AYAYMR.strings.download_ahead_info),
                ),
            ),
        )
    }
    ...
    private fun getExternalDownloaderGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_external_downloader),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = useExternalDownloader,
                    title = stringResource(AYAYMR.strings.pref_use_external_downloader),
                ),
                Preference.PreferenceItem.ListPreference(
                    preference = externalDownloaderPreference,
                    entries = packageNamesMap.toPersistentMap(),
                    title = stringResource(AYAYMR.strings.pref_external_downloader_selection),
                ),
            ),
        )
    }
    ...
    private fun DownloadLimitDialog(
        ...
        AlertDialog(
            ...
            title = { Text(stringResource(AYAYMR.strings.download_speed_limit)) },
            text = {
                Column {
                    Row(
                        modifier = Modifier
                        ...
                        OutlinedNumericChooser(
                            label = stringResource(AYAYMR.strings.download_speed_limit),
                            placeholder = "0",
                            suffix = "KiB/s",
                            value = initialValue,
                            step = 100,
                    ...
                    Text(text = stringResource(AYAYMR.strings.download_speed_limit_hint))
                }
            },
            dismissButton = {
