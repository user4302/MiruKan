package com.user4302.presentation.more.settings.screen.player.editor.codeeditor
...
class CodeEditScreenModel(
    ...
    fun save() {
        val file = currentFile.value ?: kotlin.run {
            context.toast(AYAYMR.strings.editor_save_error)
            return
        }
        ...
        try {
            ...
            context.toast(context.stringResource(AYAYMR.strings.editor_save_success))
        } catch (e: Exception) {
            logcat(LogPriority.ERROR, e)
            context.toast(e.message ?: context.stringResource(AYAYMR.strings.editor_save_error))
        }
    }
