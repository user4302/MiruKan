...
fun ChapterSettingsDialog(
    ...
    TabbedDialog(
        ...
        tabOverflowMenuContent = { closeMenu ->
            ...
            DropdownMenuItem(
                text = { Text(stringResource(AYMR.strings.action_reset)) },
                onClick = {
                    onResetToDefault()
                    closeMenu()
                },
...
fun ScanlatorFilterItem(
    ...
    Row(
        ...
        Text(
            text = stringResource(AYMR.strings.scanlator),
...
private fun ColumnScope.SortPage(
    ...
    listOf(
        AYMR.strings.sort_by_source to Manga.CHAPTER_SORTING_SOURCE,
        AYMR.strings.sort_by_number to Manga.CHAPTER_SORTING_NUMBER,
        AYMR.strings.sort_by_upload_date to Manga.CHAPTER_SORTING_UPLOAD_DATE,
        AYMR.strings.action_sort_alpha to Manga.CHAPTER_SORTING_ALPHABET,
    ).map { (titleRes, mode) ->
        SortItem(
...
private fun ColumnScope.DisplayPage(
    ...
    listOf(
        AYMR.strings.show_title to Manga.CHAPTER_DISPLAY_NAME,
        AYMR.strings.show_chapter_number to Manga.CHAPTER_DISPLAY_NUMBER,
    ).map { (titleRes, mode) ->
        RadioItem(
            label = stringResource(titleRes),
...
private fun SetAsDefaultDialog(
    ...
    AlertDialog(
        onDismissRequest = onDismissRequest,
        title = { Text(text = stringResource(AYMR.strings.chapter_settings)) },
        text = {
            Column(
                ...
                LabeledCheckbox(
                    label = stringResource(AYAYMR.strings.also_set_chapter_settings_for_library),
