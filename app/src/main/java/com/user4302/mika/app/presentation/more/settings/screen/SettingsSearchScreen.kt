...
import com.user4302.mika.presentation.core.util.runOnEnterKeyPressed
import com.user4302.presentation.components.UpIcon
import com.user4302.presentation.more.settings.Preference
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsAdvancedScreen
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsAudioScreen
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsDecoderScreen
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsGesturesScreen
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsPlayerScreen
import com.user4302.presentation.more.settings.screen.player.PlayerSettingsSubtitleScreen
                                        ...
                                        Text(
                                            text = stringResource(
                                                resource = if (isPlayer) {
                                                    AYAYMR.strings.action_search_player_settings
                                                } else {
                                                    AYMR.strings.action_search_settings
                                                },
                                            ),
...
private fun SearchResult(
                            ...
                            breadcrumbs = getLocalizedBreadcrumb(
                                nodes = buildList {
                                    if (!isPlayer && settingsData.playerSettings) {
                                        add(AYAYMR.strings.label_player_settings.getString(context))
                                    }
    ...
    Crossfade(
        ...
        when {
            it == null -> {}
            it.isEmpty() -> {
                EmptyScreen(stringResource(AYMR.strings.no_results_found))
            }
            else -> {
                LazyColumn(
