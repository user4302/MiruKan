...
import com.user4302.domain.track.model.AutoTrackState
...
import com.user4302.mika.data.track.anilist.AnilistApi
import com.user4302.mika.data.track.bangumi.BangumiApi
import com.user4302.mika.data.track.myanimelist.MyAnimeListApi
import com.user4302.mika.data.track.shikimori.ShikimoriApi
import com.user4302.mika.data.track.simkl.SimklApi
...
object SettingsTrackingScreen : SearchableSettings {
    ...
    @ReadOnlyComposable
    @Composable
    override fun getTitleRes() = AYMR.strings.pref_category_tracking

    @Composable
    override fun RowScope.AppBarAction() {
        val uriHandler = LocalUriHandler.current
        IconButton(onClick = { uriHandler.openUri("https://mika.org/help/guides/tracking/") }) {
            Icon(
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            Preference.PreferenceItem.SwitchPreference(
                ...
                title = stringResource(AYAYMR.strings.pref_auto_update_manga_sync),
            ),
            Preference.PreferenceItem.SwitchPreference(
                preference = trackPreferences.trackOnAddingToLibrary(),
                title = stringResource(AYAYMR.strings.pref_track_on_add_library),
            ),
            Preference.PreferenceItem.SwitchPreference(
                preference = trackPreferences.showNextEpisodeAiringTime(),
                title = stringResource(AYAYMR.strings.pref_show_next_episode_airing_time),
            ),
            Preference.PreferenceItem.ListPreference(
                ...
                entries = AutoTrackState.entries
                    ...
                    .toPersistentMap(),
                title = stringResource(AYAYMR.strings.pref_auto_update_manga_on_mark_read),
            ),
            Preference.PreferenceGroup(
                title = stringResource(AYMR.strings.services),
                preferenceItems = persistentListOf(
                    ...
                    Preference.PreferenceItem.TrackerPreference(
                        ...
                        login = { dialog = LoginDialog(trackerManager.kitsu, AYMR.strings.email) },
                        logout = { dialog = LogoutDialog(trackerManager.kitsu) },
                    ),
                    Preference.PreferenceItem.TrackerPreference(
                        tracker = trackerManager.mangaUpdates,
                        login = { dialog = LoginDialog(trackerManager.mangaUpdates, AYMR.strings.username) },
                    ...
                    Preference.PreferenceItem.InfoPreference(stringResource(AYMR.strings.tracking_info)),
                ),
            ),
            Preference.PreferenceGroup(
                title = stringResource(AYMR.strings.enhanced_services),
                preferenceItems = (
        ...
        AlertDialog(
            ...
            title = {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = stringResource(AYMR.strings.login_title, tracker.name),
            ...
            text = {
                Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(text = stringResource(AYMR.strings.password)) },
                        trailingIcon = {
            ...
            confirmButton = {
                Button(
                    ...
                    val id = if (processing) AYMR.strings.loading else AYMR.strings.login
    ...
    private suspend fun checkLogin(
        ...
        return try {
            ...
            withUIContext { context.toast(AYMR.strings.login_success) }
            true
        } catch (e: Throwable) {
            tracker.logout()
    ...
    private fun TrackingLogoutDialog(
        ...
        AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(AYMR.strings.logout_title, tracker.name),
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(MaterialTheme.padding.extraSmall)) {
                    ...
                    Button(
                        ...
                        onClick = {
                            tracker.logout()
                            onDismissRequest()
                            context.toast(AYMR.strings.logout_success)
                        },
                        ...
                        Text(text = stringResource(AYMR.strings.logout))
                    }
                }
            },
        )
