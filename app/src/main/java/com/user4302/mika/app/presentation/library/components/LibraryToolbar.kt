            ...
            AppBarActions(
                persistentListOf(
                    ...
                    AppBar.OverflowAction(
                        title = stringResource(AYMR.strings.action_update_library),
                        onClick = onClickGlobalUpdate,
                    ),
                    AppBar.OverflowAction(
                        title = stringResource(AYMR.strings.action_update_category),
                        onClick = onClickRefresh,
                    ),
                    AppBar.OverflowAction(
                        title = stringResource(AYMR.strings.action_open_random_manga),
