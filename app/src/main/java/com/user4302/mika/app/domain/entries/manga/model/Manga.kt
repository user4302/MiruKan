package com.user4302.domain.entries.manga.model
...
import com.user4302.mika.core.metadata.comicinfo.ComicInfoPublishingStatus
...
fun getComicInfo(
    ...
    categories = categories?.let { ComicInfo.CategoriesMika(it.joinToString()) },
    source = ComicInfo.SourceMika(sourceName),
    inker = null,
    colorist = null,
    letterer = null,
    coverArtist = null,
