...
object PlayerSettingsGesturesScreen : SearchableSettings {
    ...
    @ReadOnlyComposable
    @Composable
    override fun getTitleRes() = AYAYMR.strings.pref_player_gestures
    ...
    private fun getSlidersGroup(gesturePreferences: GesturePreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_player_sliders),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = enableVolumeBrightnessGestures,
                    title = stringResource(AYAYMR.strings.enable_volume_brightness_gestures),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = swapVol,
                    title = stringResource(AYAYMR.strings.pref_controls_swap_vol_brightness),
                ),
            ),
        )
    }
    ...
    private fun getSeekingGroup(gesturePreferences: GesturePreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_player_seeking),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    preference = enableHorizontalSeekGesture,
                    title = stringResource(AYAYMR.strings.enable_horizontal_seek_gesture),
                    subtitle = stringResource(AYAYMR.strings.enable_horizontal_seek_gesture_summary),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = showSeekbar,
                    title = stringResource(AYAYMR.strings.pref_show_seekbar),
                ),
                Preference.PreferenceItem.TextPreference(
                    title = stringResource(AYAYMR.strings.pref_default_intro_length),
                ...
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = persistentMapOf(
                        30 to stringResource(AYAYMR.strings.pref_skip_30),
                        20 to stringResource(AYAYMR.strings.pref_skip_20),
                        10 to stringResource(AYAYMR.strings.pref_skip_10),
                        5 to stringResource(AYAYMR.strings.pref_skip_5),
                        3 to stringResource(AYAYMR.strings.pref_skip_3),
                        0 to stringResource(AYAYMR.strings.pref_skip_disable),
                    ),
                    title = stringResource(AYAYMR.strings.pref_skip_length),
                ),
                Preference.PreferenceItem.SwitchPreference(
                    preference = playerSmoothSeek,
                    title = stringResource(AYAYMR.strings.pref_player_smooth_seek),
                    subtitle = stringResource(AYAYMR.strings.pref_player_smooth_seek_summary),
                ),
            ),
        )
    }
    ...
    private fun getDoubleTapGroup(gesturePreferences: GesturePreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_double_tap),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_left_double_tap),
                ),
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_center_double_tap),
                ),
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_right_double_tap),
                ),
                Preference.PreferenceItem.InfoPreference(
                    title = stringResource(AYAYMR.strings.pref_double_tap_info),
                ),
            ),
        )
    }
    ...
    private fun getMediaControlsGroup(gesturePreferences: GesturePreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AYAYMR.strings.pref_category_media_controls),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_media_previous),
                ),
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_media_playpause),
                ),
                Preference.PreferenceItem.ListPreference(
                    ...
                    title = stringResource(AYAYMR.strings.pref_media_next),
                ),
                Preference.PreferenceItem.InfoPreference(
                    title = stringResource(AYAYMR.strings.pref_media_info),
                ),
            ),
        )
    }
    ...
    fun SkipIntroLengthDialog(
        ...
        AlertDialog(
            ...
            title = { Text(text = stringResource(AYAYMR.strings.pref_intro_length)) },
            text = {
                Box(
