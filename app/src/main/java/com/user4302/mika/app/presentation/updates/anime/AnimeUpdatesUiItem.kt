...
import com.user4302.presentation.entries.anime.components.EpisodeDownloadIndicator
...
internal fun LazyListScope.animeUpdatesLastUpdatedItem(
    ...
    item(key = "animeUpdates-lastUpdated") {
        Box(
            ...
            Text(
                text = stringResource(AYMR.strings.updates_last_update_info, relativeTimeSpanString(lastUpdated)),
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (!update.seen) {
                    Icon(
                        ...
                        contentDescription = stringResource(AYMR.strings.unread),
                        modifier = Modifier
                            .height(8.dp)
                            .padding(end = 4.dp),
                ...
                if (update.bookmark) {
                    Icon(
                        ...
                        contentDescription = stringResource(AYMR.strings.action_filter_bookmarked),
                        modifier = Modifier
                            .sizeIn(
                ...
                if (update.fillermark) {
                    Icon(
                        ...
                        contentDescription = stringResource(AYAYMR.strings.action_filter_fillermarked),
                        modifier = Modifier
                            .sizeIn(
                                maxHeight = with(LocalDensity.current) { textHeight.toDp() - 2.dp },
                            ),
